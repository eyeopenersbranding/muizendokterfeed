...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_greenred = 'Groen') AND (log_land = 'NL')";
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_greenred = 'Rood') AND (log_land = 'NL')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_cancelled = '1') AND (log_land = 'NL')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_continuation = '1') AND (log_land = 'NL')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_question = '1') AND (log_land = 'NL')";
$result = mysqli_query($con, $sql);
...
if ($result)
	...
	$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_colleague = '1') AND (log_land = 'NL')";
$result = mysqli_query($con, $sql);
...
$ratio_final_nl = $total_green / $ratio_total_nl* 100;
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Muizen') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND log_greenred IN ('Groen', 'Rood') AND (log_pest = 'Motten')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Mieren') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Ratten') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Vliegen') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Wespen') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Spinnen') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Vlooien') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Bedwantsen') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Zilvervisjes') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Tapijtkevers') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Vogels') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_pest = 'Kakkerlakken') AND log_greenred IN ('Groen', 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '1') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '2') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '3') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '4') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '5') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '6') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '7') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '8') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '9') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '10') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '11') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '12') AND (log_greenred = 'Rood')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '1') AND (log_cancelled = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '2') AND (log_cancelled = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '3') AND (log_cancelled = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '4') AND (log_cancelled = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '5') AND (log_cancelled = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '6') AND (log_cancelled = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '7') AND (log_cancelled = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '8') AND (log_cancelled = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '9') AND (log_cancelled = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '10') AND (log_cancelled = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '11') AND (log_cancelled = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '1') AND (log_question = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '2') AND (log_question = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '3') AND (log_question = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '4') AND (log_question = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '5') AND (log_question = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '6') AND (log_question = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '7') AND (log_question = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '8') AND (log_question = '1')";
$result = mysqli_query($con, $sql);
...
$sql = "SELECT * FROM md_log WHERE (cast(log_date as date) BETWEEN '$startdate' AND '$enddate') AND (log_land = 'NL') AND (log_notes = '9') AND (log_question = '1')";
$result = mysqli_query($con, $sql);
