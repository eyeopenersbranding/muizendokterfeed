                    ...
                    <div class="col-sm-12 mb-4">
						      ...
						      <div class="col-lg-6">
								...
								<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
								  <div class="card-header"><strong>Klant</strong><small> heeft een vraag</small></div>
									    ...
									    <div class="row form-group">
											...
											<div class="col-12 col-md-9">
											  <select name="log_notes" id="select" class="form-control">
												<option value="1">Hoe laat komt de bestrijder precies?</option>
												<option value="2">Wanneer staat de afspraak ook alweer?</option>
												<option value="3">Is er al iets bekend over mijn klacht?</option>
												<option value="4">Kunnen jullie mij voor vertrek bellen?</option>
												<option value="5">Belt terug omdat wij de klant gebeld hebben</option>
												<option value="6">Vraag over factuur</option>
												<option value="7">Geen afspraakbevestiging / instructiemail ontvangen</option>
												<option value="8">Is het mogelijk om de afspraak te verzetten?</option>
